...
const navigation = [
  ...
  { name: 'Categorías', href: '/categorias', icon: Tags, roles: ['ADMIN', 'ENCARGADO_BENEFICENCIA'] },
  { name: 'Proveedores', href: '/proveedores', icon: Truck, roles: ['ADMIN', 'ENCARGADO_BENEFICENCIA'] },
  { name: 'Ubicaciones', href: '/ubicaciones', icon: MapPin, roles: ['ADMIN', 'ENCARGADO_BENEFICENCIA'] },
